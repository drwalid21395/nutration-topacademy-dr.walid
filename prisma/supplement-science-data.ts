...
اسم الملف:
prisma/supplement-science-data.ts

وظيفة الملف:
بيانات علمية مساندة لحاسبة المكملات:
1) SUPPLEMENT_INGREDIENTS: المكونات النشطة مع وحدتها
   وحدودها العليا الآمنة (للكشف عن التكرار والتجاوز).
2) SUPPLEMENT_REFERENCES: مراجع علمية لكل مكمل.

لماذا نحتاجه؟
حتى تكشف حاسبة المكملات أن مستخدمًا يضاعف جرعة مكون (مثلًا
بروتين من مكملين معًا) وتنبهه، وعندما تريد عرض مصدر المعلومة.

متى يعمل؟
ملف بيانات يُستورد من prisma/seed.ts وخدمات المكملات.
