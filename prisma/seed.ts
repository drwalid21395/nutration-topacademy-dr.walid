/**
 * بذرة قاعدة البيانات التجريبية.
 * - يحذف بيانات العروض التجريبية ثم يعيد إنشاءها
 * - أطعمة + تصنيفات + مكملات + صفحات محتوى
 * - حسابات تجريبية: سباح / ولي أمر / مدرب / اختصاصي / مدير
 * - ملف سباح كامل + احتياجات + خطة أسبوعية + سجلات + إشعارات
 */
