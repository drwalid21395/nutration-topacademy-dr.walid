/*
=================================================
ملف اختبار (Test) — تحويلات Polar
=================================================
يختبر دوال polar-mapping.ts (تصنيف الرياضة وتحويل المدة).
اسم الملف:
src/lib/wearables/polar-mapping.test.ts
=================================================
*/
...
// الدوال: من الملف المحلي ./polar-mapping (الهدف من الاختبار).
